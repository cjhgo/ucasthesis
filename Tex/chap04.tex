...
在上一章中，我们发现了LazyAsync的性能提升的相对大小和冗余计算的比例有关。
...
通过上边的例子我们可以看到，全局解由单个局部解构成时有利于开启lazy data coherency 。
...
基于此，我们最终提出了一种基于解的局部性的自适应优化方法，它指导LazyAsync
...
在自适应优化方法中，我们通过在线地观察解的局部性方式来自动选择LazyAsync的开启轮次。
...
\section{本章小结}
在本章中，我们先是通过小例子直观说明了全局解和局部解的关系如何影响LazyAsync中存在的冗余计算。
在此基础上，我们提出了解的局部性的概念。
